...
int main(void) {
  ...
  BOARD_init_all();
	...
	//xTaskCreate(task_Camera_Double_Integration, "Task_C2", configMINIMAL_STACK_SIZE + 100, NULL, task_Camera_Double_Integration_PRIORITY, NULL);
	//xTaskCreate(task_Piste, "Task_Track", configMINIMAL_STACK_SIZE + 150, NULL, task_Piste_PRIORITY, NULL);
	//xTaskCreate(task_Piste_Display, "Task_TD", configMINIMAL_STACK_SIZE + 150, NULL, task_Piste_Display_PRIORITY, NULL);
	//xTaskCreate(task_Motor_Control, "Task_MC", configMINIMAL_STACK_SIZE + 150, NULL, task_Motor_Control_PRIORITY, NULL);
